#[doc = "Reader of register REFOTRIMCLR"]
pub type R = crate::R<u32, super::REFOTRIMCLR>;
#[doc = "Writer for register REFOTRIMCLR"]
pub type W = crate::W<u32, super::REFOTRIMCLR>;
#[doc = "Register REFOTRIMCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::REFOTRIMCLR {
    type Type = u32;
    #[inline(always)]
