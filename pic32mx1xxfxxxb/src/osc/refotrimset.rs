#[doc = "Reader of register REFOTRIMSET"]
pub type R = crate::R<u32, super::REFOTRIMSET>;
#[doc = "Writer for register REFOTRIMSET"]
pub type W = crate::W<u32, super::REFOTRIMSET>;
#[doc = "Register REFOTRIMSET `reset()`'s with value 0"]
impl crate::ResetValue for super::REFOTRIMSET {
    type Type = u32;
    #[inline(always)]
