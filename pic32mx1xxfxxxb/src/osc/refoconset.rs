...
impl W {
    ...
    #[doc = "Bit 9"]
    #[inline]
    pub fn divswen(&mut self) -> _DIVSWENW {
        _DIVSWENW { w: self }
    }
    #[doc = "Bit 11"]
    #[inline]
    pub fn rslp(&mut self) -> _RSLPW {
        _RSLPW { w: self }
    }
    #[doc = "Bit 12"]
    #[inline]
