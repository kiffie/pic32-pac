#[doc = "Reader of register DMASTATCLR"]
pub type R = crate::R<u32, super::DMASTATCLR>;
#[doc = "Writer for register DMASTATCLR"]
pub type W = crate::W<u32, super::DMASTATCLR>;
#[doc = "Register DMASTATCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::DMASTATCLR {
    type Type = u32;
    #[inline(always)]
