...
impl R {
    ...
    #[doc = "Bit 4"]
    #[inline]
    pub fn epcondis(&self) -> EPCONDISR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 4"]
    #[inline]
    pub fn epcondis(&mut self) -> _EPCONDISW {
        _EPCONDISW { w: self }
    }
    #[doc = "Bit 6"]
    #[inline]
