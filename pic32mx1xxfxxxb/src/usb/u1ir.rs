#[doc = "Reader of register U1IR"]
pub type R = crate::R<u32, super::U1IR>;
#[doc = "Writer for register U1IR"]
pub type W = crate::W<u32, super::U1IR>;
#[doc = "Register U1IR `reset()`'s with value 0"]
impl crate::ResetValue for super::U1IR {
    type Type = u32;
    #[inline(always)]
