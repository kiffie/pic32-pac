#[doc = "Reader of register T2CONSET"]
pub type R = crate::R<u32, super::T2CONSET>;
#[doc = "Writer for register T2CONSET"]
pub type W = crate::W<u32, super::T2CONSET>;
#[doc = "Register T2CONSET `reset()`'s with value 0"]
impl crate::ResetValue for super::T2CONSET {
    type Type = u32;
    #[inline(always)]
