#[doc = "Register `IPC5SET` reader"]
pub struct R(crate::R<IPC5SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IPC5SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<IPC5SET_SPEC>> for R {
    fn from(reader: crate::R<IPC5SET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IPC5SET` writer"]
pub struct W(crate::W<IPC5SET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IPC5SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<IPC5SET_SPEC>> for W {
    fn from(writer: crate::W<IPC5SET_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct IPC5SET_SPEC;
impl crate::RegisterSpec for IPC5SET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ipc5set::R](R) reader structure"]
impl crate::Readable for IPC5SET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ipc5set::W](W) writer structure"]
impl crate::Writable for IPC5SET_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets IPC5SET to value 0"]
impl crate::Resettable for IPC5SET_SPEC {
    #[inline(always)]
