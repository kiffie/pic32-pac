#[doc = "Reader of register IPC6SET"]
pub type R = crate::R<u32, super::IPC6SET>;
#[doc = "Writer for register IPC6SET"]
pub type W = crate::W<u32, super::IPC6SET>;
#[doc = "Register IPC6SET `reset()`'s with value 0"]
impl crate::ResetValue for super::IPC6SET {
    type Type = u32;
    #[inline(always)]
