#[doc = "Reader of register IPC7CLR"]
pub type R = crate::R<u32, super::IPC7CLR>;
#[doc = "Writer for register IPC7CLR"]
pub type W = crate::W<u32, super::IPC7CLR>;
#[doc = "Register IPC7CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::IPC7CLR {
    type Type = u32;
    #[inline(always)]
