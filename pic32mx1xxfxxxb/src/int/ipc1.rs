#[doc = "Reader of register IPC1"]
pub type R = crate::R<u32, super::IPC1>;
#[doc = "Writer for register IPC1"]
pub type W = crate::W<u32, super::IPC1>;
#[doc = "Register IPC1 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPC1 {
    type Type = u32;
    #[inline(always)]
