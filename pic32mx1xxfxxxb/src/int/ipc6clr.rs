#[doc = "Reader of register IPC6CLR"]
pub type R = crate::R<u32, super::IPC6CLR>;
#[doc = "Writer for register IPC6CLR"]
pub type W = crate::W<u32, super::IPC6CLR>;
#[doc = "Register IPC6CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::IPC6CLR {
    type Type = u32;
    #[inline(always)]
