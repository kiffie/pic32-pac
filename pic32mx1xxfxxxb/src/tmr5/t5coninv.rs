#[doc = "Reader of register T5CONINV"]
pub type R = crate::R<u32, super::T5CONINV>;
#[doc = "Writer for register T5CONINV"]
pub type W = crate::W<u32, super::T5CONINV>;
#[doc = "Register T5CONINV `reset()`'s with value 0"]
impl crate::ResetValue for super::T5CONINV {
    type Type = u32;
    #[inline(always)]
