#[doc = "Register `STATCLR` reader"]
pub struct R(crate::R<STATCLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<STATCLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<STATCLR_SPEC>> for R {
    fn from(reader: crate::R<STATCLR_SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::convert::From<crate::W<STATCLR_SPEC>> for W {
...
#[doc = "`read()` method returns [statclr::R](R) reader structure"]
impl crate::Readable for STATCLR_SPEC {
    type Reader = R;
}
