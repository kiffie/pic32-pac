#[doc = "Reader of register PMD6"]
pub type R = crate::R<u32, super::PMD6>;
#[doc = "Writer for register PMD6"]
pub type W = crate::W<u32, super::PMD6>;
#[doc = "Register PMD6 `reset()`'s with value 0"]
impl crate::ResetValue for super::PMD6 {
    type Type = u32;
    #[inline(always)]
