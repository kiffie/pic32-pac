#[doc = "Reader of register PORT"]
pub type R = crate::R<u32, super::PORT>;
#[doc = "Writer for register PORT"]
pub type W = crate::W<u32, super::PORT>;
#[doc = "Register PORT `reset()`'s with value 0"]
impl crate::ResetValue for super::PORT {
    type Type = u32;
    #[inline(always)]
