#[doc = "Reader of register CNPDINV"]
pub type R = crate::R<u32, super::CNPDINV>;
#[doc = "Writer for register CNPDINV"]
pub type W = crate::W<u32, super::CNPDINV>;
#[doc = "Register CNPDINV `reset()`'s with value 0"]
impl crate::ResetValue for super::CNPDINV {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `CNPDB6`"]
pub type CNPDB6_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `CNPDB6`"]
...
#[doc = "Reader of field `CNPDB12`"]
pub type CNPDB12_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `CNPDB12`"]
