#[doc = "Reader of register ANSEL"]
pub type R = crate::R<u32, super::ANSEL>;
#[doc = "Writer for register ANSEL"]
pub type W = crate::W<u32, super::ANSEL>;
#[doc = "Register ANSEL `reset()`'s with value 0xf00f"]
impl crate::ResetValue for super::ANSEL {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `ANSB12`"]
pub type ANSB12_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `ANSB12`"]
