#[doc = "Reader of register PORTSET"]
pub type R = crate::R<u32, super::PORTSET>;
#[doc = "Writer for register PORTSET"]
pub type W = crate::W<u32, super::PORTSET>;
#[doc = "Register PORTSET `reset()`'s with value 0"]
impl crate::ResetValue for super::PORTSET {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `RB6`"]
pub type RB6_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RB6`"]
pub struct RB6_W<'a> {
    w: &'a mut W,
}
impl<'a> RB6_W<'a> {
...
#[doc = "Reader of field `RB10`"]
pub type RB10_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RB10`"]
pub struct RB10_W<'a> {
    w: &'a mut W,
}
impl<'a> RB10_W<'a> {
...
#[doc = "Reader of field `RB11`"]
pub type RB11_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RB11`"]
pub struct RB11_W<'a> {
    w: &'a mut W,
}
impl<'a> RB11_W<'a> {
...
#[doc = "Reader of field `RB12`"]
pub type RB12_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RB12`"]
pub struct RB12_W<'a> {
    w: &'a mut W,
}
impl<'a> RB12_W<'a> {
