#[doc = "Reader of register CNENCLR"]
pub type R = crate::R<u32, super::CNENCLR>;
#[doc = "Writer for register CNENCLR"]
pub type W = crate::W<u32, super::CNENCLR>;
#[doc = "Register CNENCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::CNENCLR {
    type Type = u32;
    #[inline(always)]
