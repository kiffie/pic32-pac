...
impl W {
    ...
    #[doc = "Bit 9"]
    #[inline]
    pub fn disslw(&mut self) -> _DISSLWW {
        _DISSLWW { w: self }
    }
    #[doc = "Bit 10"]
    #[inline]
    pub fn a10m(&mut self) -> _A10MW {
        _A10MW { w: self }
    }
    #[doc = "Bit 11"]
    #[inline]
    pub fn strict(&mut self) -> _STRICTW {
        _STRICTW { w: self }
    }
    #[doc = "Bit 12"]
    #[inline]
    pub fn sclrel(&mut self) -> _SCLRELW {
        _SCLRELW { w: self }
    }
    #[doc = "Bit 13"]
    #[inline]
