#[doc = "Reader of register T3CONSET"]
pub type R = crate::R<u32, super::T3CONSET>;
#[doc = "Writer for register T3CONSET"]
pub type W = crate::W<u32, super::T3CONSET>;
#[doc = "Register T3CONSET `reset()`'s with value 0"]
impl crate::ResetValue for super::T3CONSET {
    type Type = u32;
    #[inline(always)]
