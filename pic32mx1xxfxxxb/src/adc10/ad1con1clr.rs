...
impl W {
    ...
    #[doc = "Bit 1"]
    #[inline]
    pub fn samp(&mut self) -> _SAMPW {
        _SAMPW { w: self }
    }
    #[doc = "Bit 2"]
    #[inline]
    pub fn asam(&mut self) -> _ASAMW {
        _ASAMW { w: self }
    }
    #[doc = "Bit 4"]
    #[inline]
    pub fn clrasam(&mut self) -> _CLRASAMW {
        _CLRASAMW { w: self }
    }
    #[doc = "Bits 5:7"]
    #[inline]
