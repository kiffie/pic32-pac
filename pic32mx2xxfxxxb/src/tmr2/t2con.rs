#[doc = "Reader of register T2CON"]
pub type R = crate::R<u32, super::T2CON>;
#[doc = "Writer for register T2CON"]
pub type W = crate::W<u32, super::T2CON>;
#[doc = "Register T2CON `reset()`'s with value 0"]
impl crate::ResetValue for super::T2CON {
    type Type = u32;
    #[inline(always)]
