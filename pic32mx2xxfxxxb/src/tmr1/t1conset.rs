#[doc = "Reader of register T1CONSET"]
pub type R = crate::R<u32, super::T1CONSET>;
#[doc = "Writer for register T1CONSET"]
pub type W = crate::W<u32, super::T1CONSET>;
#[doc = "Register T1CONSET `reset()`'s with value 0"]
impl crate::ResetValue for super::T1CONSET {
    type Type = u32;
    #[inline(always)]
