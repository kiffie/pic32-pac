#[doc = "Reader of register DCH0SSA"]
pub type R = crate::R<u32, super::DCH0SSA>;
#[doc = "Writer for register DCH0SSA"]
pub type W = crate::W<u32, super::DCH0SSA>;
#[doc = "Register DCH0SSA `reset()`'s with value 0"]
impl crate::ResetValue for super::DCH0SSA {
    type Type = u32;
    #[inline(always)]
