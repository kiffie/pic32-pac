#[doc = "Reader of register CSIZ"]
pub type R = crate::R<u32, super::CSIZ>;
#[doc = "Writer for register CSIZ"]
pub type W = crate::W<u32, super::CSIZ>;
#[doc = "Register CSIZ `reset()`'s with value 0"]
impl crate::ResetValue for super::CSIZ {
    type Type = u32;
    #[inline(always)]
