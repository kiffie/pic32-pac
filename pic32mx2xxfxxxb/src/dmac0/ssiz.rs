#[doc = "Reader of register SSIZ"]
pub type R = crate::R<u32, super::SSIZ>;
#[doc = "Writer for register SSIZ"]
pub type W = crate::W<u32, super::SSIZ>;
#[doc = "Register SSIZ `reset()`'s with value 0"]
impl crate::ResetValue for super::SSIZ {
    type Type = u32;
    #[inline(always)]
