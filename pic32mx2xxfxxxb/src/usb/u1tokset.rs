#[doc = "Reader of register U1TOKSET"]
pub type R = crate::R<u32, super::U1TOKSET>;
#[doc = "Writer for register U1TOKSET"]
pub type W = crate::W<u32, super::U1TOKSET>;
#[doc = "Register U1TOKSET `reset()`'s with value 0"]
impl crate::ResetValue for super::U1TOKSET {
    type Type = u32;
    #[inline(always)]
