#[doc = "Reader of register U1ADDRSET"]
pub type R = crate::R<u32, super::U1ADDRSET>;
#[doc = "Writer for register U1ADDRSET"]
pub type W = crate::W<u32, super::U1ADDRSET>;
#[doc = "Register U1ADDRSET `reset()`'s with value 0"]
impl crate::ResetValue for super::U1ADDRSET {
    type Type = u32;
    #[inline(always)]
