#[doc = "Reader of register U1EP0SET"]
pub type R = crate::R<u32, super::U1EP0SET>;
#[doc = "Writer for register U1EP0SET"]
pub type W = crate::W<u32, super::U1EP0SET>;
#[doc = "Register U1EP0SET `reset()`'s with value 0"]
impl crate::ResetValue for super::U1EP0SET {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `LSPD`"]
pub type LSPD_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `LSPD`"]
pub struct LSPD_W<'a> {
    w: &'a mut W,
}
impl<'a> LSPD_W<'a> {
