#[doc = "Reader of register T5CONCLR"]
pub type R = crate::R<u32, super::T5CONCLR>;
#[doc = "Writer for register T5CONCLR"]
pub type W = crate::W<u32, super::T5CONCLR>;
#[doc = "Register T5CONCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::T5CONCLR {
    type Type = u32;
    #[inline(always)]
