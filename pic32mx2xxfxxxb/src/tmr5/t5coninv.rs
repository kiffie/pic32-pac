#[doc = "Register `T5CONINV` reader"]
pub struct R(crate::R<T5CONINV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<T5CONINV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<T5CONINV_SPEC>> for R {
    fn from(reader: crate::R<T5CONINV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `T5CONINV` writer"]
pub struct W(crate::W<T5CONINV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<T5CONINV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<T5CONINV_SPEC>> for W {
    fn from(writer: crate::W<T5CONINV_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "T5CONINV register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [t5coninv](index.html) module"]
pub struct T5CONINV_SPEC;
impl crate::RegisterSpec for T5CONINV_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [t5coninv::R](R) reader structure"]
impl crate::Readable for T5CONINV_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [t5coninv::W](W) writer structure"]
impl crate::Writable for T5CONINV_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets T5CONINV to value 0"]
impl crate::Resettable for T5CONINV_SPEC {
    #[inline(always)]
