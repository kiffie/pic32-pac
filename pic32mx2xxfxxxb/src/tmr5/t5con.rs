#[doc = "Reader of register T5CON"]
pub type R = crate::R<u32, super::T5CON>;
#[doc = "Writer for register T5CON"]
pub type W = crate::W<u32, super::T5CON>;
#[doc = "Register T5CON `reset()`'s with value 0"]
impl crate::ResetValue for super::T5CON {
    type Type = u32;
    #[inline(always)]
