#[doc = "Reader of register T5CONSET"]
pub type R = crate::R<u32, super::T5CONSET>;
#[doc = "Writer for register T5CONSET"]
pub type W = crate::W<u32, super::T5CONSET>;
#[doc = "Register T5CONSET `reset()`'s with value 0"]
impl crate::ResetValue for super::T5CONSET {
    type Type = u32;
    #[inline(always)]
