#[doc = "Reader of register IPC0"]
pub type R = crate::R<u32, super::IPC0>;
#[doc = "Writer for register IPC0"]
pub type W = crate::W<u32, super::IPC0>;
#[doc = "Register IPC0 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPC0 {
    type Type = u32;
    #[inline(always)]
