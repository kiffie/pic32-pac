#[doc = "Reader of register IPC8"]
pub type R = crate::R<u32, super::IPC8>;
#[doc = "Writer for register IPC8"]
pub type W = crate::W<u32, super::IPC8>;
#[doc = "Register IPC8 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPC8 {
    type Type = u32;
    #[inline(always)]
