#[doc = "Reader of register IPC4"]
pub type R = crate::R<u32, super::IPC4>;
#[doc = "Writer for register IPC4"]
pub type W = crate::W<u32, super::IPC4>;
#[doc = "Register IPC4 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPC4 {
    type Type = u32;
    #[inline(always)]
