#[doc = "Reader of register IPC7"]
pub type R = crate::R<u32, super::IPC7>;
#[doc = "Writer for register IPC7"]
pub type W = crate::W<u32, super::IPC7>;
#[doc = "Register IPC7 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPC7 {
    type Type = u32;
    #[inline(always)]
