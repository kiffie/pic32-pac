#[doc = "Reader of register REFOTRIMINV"]
pub type R = crate::R<u32, super::REFOTRIMINV>;
#[doc = "Writer for register REFOTRIMINV"]
pub type W = crate::W<u32, super::REFOTRIMINV>;
#[doc = "Register REFOTRIMINV `reset()`'s with value 0"]
impl crate::ResetValue for super::REFOTRIMINV {
    type Type = u32;
    #[inline(always)]
