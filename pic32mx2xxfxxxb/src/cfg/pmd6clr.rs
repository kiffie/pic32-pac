#[doc = "Reader of register PMD6CLR"]
pub type R = crate::R<u32, super::PMD6CLR>;
#[doc = "Writer for register PMD6CLR"]
pub type W = crate::W<u32, super::PMD6CLR>;
#[doc = "Register PMD6CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::PMD6CLR {
    type Type = u32;
    #[inline(always)]
