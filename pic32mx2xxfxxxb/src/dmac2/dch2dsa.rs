#[doc = "Reader of register DCH2DSA"]
pub type R = crate::R<u32, super::DCH2DSA>;
#[doc = "Writer for register DCH2DSA"]
pub type W = crate::W<u32, super::DCH2DSA>;
#[doc = "Register DCH2DSA `reset()`'s with value 0"]
impl crate::ResetValue for super::DCH2DSA {
    type Type = u32;
    #[inline(always)]
