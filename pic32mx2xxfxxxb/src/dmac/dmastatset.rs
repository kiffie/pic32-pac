#[doc = "Reader of register DMASTATSET"]
pub type R = crate::R<u32, super::DMASTATSET>;
#[doc = "Writer for register DMASTATSET"]
pub type W = crate::W<u32, super::DMASTATSET>;
#[doc = "Register DMASTATSET `reset()`'s with value 0"]
impl crate::ResetValue for super::DMASTATSET {
    type Type = u32;
    #[inline(always)]
