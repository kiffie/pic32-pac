#[doc = "Reader of register DCRCXOR"]
pub type R = crate::R<u32, super::DCRCXOR>;
#[doc = "Writer for register DCRCXOR"]
pub type W = crate::W<u32, super::DCRCXOR>;
#[doc = "Register DCRCXOR `reset()`'s with value 0"]
impl crate::ResetValue for super::DCRCXOR {
    type Type = u32;
    #[inline(always)]
