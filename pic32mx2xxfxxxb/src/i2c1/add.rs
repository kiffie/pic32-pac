#[doc = "Reader of register ADD"]
pub type R = crate::R<u32, super::ADD>;
#[doc = "Writer for register ADD"]
pub type W = crate::W<u32, super::ADD>;
#[doc = "Register ADD `reset()`'s with value 0"]
impl crate::ResetValue for super::ADD {
    type Type = u32;
    #[inline(always)]
