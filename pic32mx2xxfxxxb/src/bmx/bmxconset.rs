#[doc = "Reader of register BMXCONSET"]
pub type R = crate::R<u32, super::BMXCONSET>;
#[doc = "Writer for register BMXCONSET"]
pub type W = crate::W<u32, super::BMXCONSET>;
#[doc = "Register BMXCONSET `reset()`'s with value 0"]
impl crate::ResetValue for super::BMXCONSET {
    type Type = u32;
    #[inline(always)]
