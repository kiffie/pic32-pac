#[doc = "Reader of register BMXCON"]
pub type R = crate::R<u32, super::BMXCON>;
#[doc = "Writer for register BMXCON"]
pub type W = crate::W<u32, super::BMXCON>;
#[doc = "Register BMXCON `reset()`'s with value 0x001f_0041"]
impl crate::ResetValue for super::BMXCON {
    type Type = u32;
    #[inline(always)]
