#[doc = "Reader of register T4CONCLR"]
pub type R = crate::R<u32, super::T4CONCLR>;
#[doc = "Writer for register T4CONCLR"]
pub type W = crate::W<u32, super::T4CONCLR>;
#[doc = "Register T4CONCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::T4CONCLR {
    type Type = u32;
    #[inline(always)]
