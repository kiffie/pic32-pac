#[doc = "Reader of register T4CON"]
pub type R = crate::R<u32, super::T4CON>;
#[doc = "Writer for register T4CON"]
pub type W = crate::W<u32, super::T4CON>;
#[doc = "Register T4CON `reset()`'s with value 0"]
impl crate::ResetValue for super::T4CON {
    type Type = u32;
    #[inline(always)]
