#[doc = "Reader of register T4CONINV"]
pub type R = crate::R<u32, super::T4CONINV>;
#[doc = "Writer for register T4CONINV"]
pub type W = crate::W<u32, super::T4CONINV>;
#[doc = "Register T4CONINV `reset()`'s with value 0"]
impl crate::ResetValue for super::T4CONINV {
    type Type = u32;
    #[inline(always)]
