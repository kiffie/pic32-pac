#[doc = "Reader of register T3CON"]
pub type R = crate::R<u32, super::T3CON>;
#[doc = "Writer for register T3CON"]
pub type W = crate::W<u32, super::T3CON>;
#[doc = "Register T3CON `reset()`'s with value 0"]
impl crate::ResetValue for super::T3CON {
    type Type = u32;
    #[inline(always)]
