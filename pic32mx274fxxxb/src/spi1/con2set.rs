#[doc = "Reader of register CON2SET"]
pub type R = crate::R<u32, super::CON2SET>;
#[doc = "Writer for register CON2SET"]
pub type W = crate::W<u32, super::CON2SET>;
#[doc = "Register CON2SET `reset()`'s with value 0"]
impl crate::ResetValue for super::CON2SET {
    type Type = u32;
    #[inline(always)]
