#[doc = "Reader of register CHEMSK"]
pub type R = crate::R<u32, super::CHEMSK>;
#[doc = "Writer for register CHEMSK"]
pub type W = crate::W<u32, super::CHEMSK>;
#[doc = "Register CHEMSK `reset()`'s with value 0"]
impl crate::ResetValue for super::CHEMSK {
    type Type = u32;
    #[inline(always)]
