#[doc = "Reader of register CHEMSKCLR"]
pub type R = crate::R<u32, super::CHEMSKCLR>;
#[doc = "Writer for register CHEMSKCLR"]
pub type W = crate::W<u32, super::CHEMSKCLR>;
#[doc = "Register CHEMSKCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::CHEMSKCLR {
    type Type = u32;
    #[inline(always)]
