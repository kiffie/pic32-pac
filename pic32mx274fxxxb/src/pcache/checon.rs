#[doc = "Reader of register CHECON"]
pub type R = crate::R<u32, super::CHECON>;
#[doc = "Writer for register CHECON"]
pub type W = crate::W<u32, super::CHECON>;
#[doc = "Register CHECON `reset()`'s with value 0x07"]
impl crate::ResetValue for super::CHECON {
    type Type = u32;
    #[inline(always)]
