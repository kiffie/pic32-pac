#[doc = "Reader of register CHEMSKSET"]
pub type R = crate::R<u32, super::CHEMSKSET>;
#[doc = "Writer for register CHEMSKSET"]
pub type W = crate::W<u32, super::CHEMSKSET>;
#[doc = "Register CHEMSKSET `reset()`'s with value 0"]
impl crate::ResetValue for super::CHEMSKSET {
    type Type = u32;
    #[inline(always)]
