#[doc = "Reader of register CHECONCLR"]
pub type R = crate::R<u32, super::CHECONCLR>;
#[doc = "Writer for register CHECONCLR"]
pub type W = crate::W<u32, super::CHECONCLR>;
#[doc = "Register CHECONCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::CHECONCLR {
    type Type = u32;
    #[inline(always)]
