#[doc = "Reader of register PMRADDRINV"]
pub type R = crate::R<u32, super::PMRADDRINV>;
#[doc = "Writer for register PMRADDRINV"]
pub type W = crate::W<u32, super::PMRADDRINV>;
#[doc = "Register PMRADDRINV `reset()`'s with value 0"]
impl crate::ResetValue for super::PMRADDRINV {
    type Type = u32;
    #[inline(always)]
