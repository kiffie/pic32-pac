#[doc = "Reader of register DCH2SSA"]
pub type R = crate::R<u32, super::DCH2SSA>;
#[doc = "Writer for register DCH2SSA"]
pub type W = crate::W<u32, super::DCH2SSA>;
#[doc = "Register DCH2SSA `reset()`'s with value 0"]
impl crate::ResetValue for super::DCH2SSA {
    type Type = u32;
    #[inline(always)]
