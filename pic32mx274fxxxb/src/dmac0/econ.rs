#[doc = "Reader of register ECON"]
pub type R = crate::R<u32, super::ECON>;
#[doc = "Writer for register ECON"]
pub type W = crate::W<u32, super::ECON>;
#[doc = "Register ECON `reset()`'s with value 0x00ff_ff00"]
impl crate::ResetValue for super::ECON {
    type Type = u32;
    #[inline(always)]
