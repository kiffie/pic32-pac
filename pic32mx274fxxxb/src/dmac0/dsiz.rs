#[doc = "Reader of register DSIZ"]
pub type R = crate::R<u32, super::DSIZ>;
#[doc = "Writer for register DSIZ"]
pub type W = crate::W<u32, super::DSIZ>;
#[doc = "Register DSIZ `reset()`'s with value 0"]
impl crate::ResetValue for super::DSIZ {
    type Type = u32;
    #[inline(always)]
