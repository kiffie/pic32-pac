#[doc = "Reader of register SPTR"]
pub type R = crate::R<u32, super::SPTR>;
#[doc = "Writer for register SPTR"]
pub type W = crate::W<u32, super::SPTR>;
#[doc = "Register SPTR `reset()`'s with value 0"]
impl crate::ResetValue for super::SPTR {
    type Type = u32;
    #[inline(always)]
