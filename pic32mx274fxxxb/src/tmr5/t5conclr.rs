#[doc = "Register `T5CONCLR` reader"]
pub struct R(crate::R<T5CONCLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<T5CONCLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<T5CONCLR_SPEC>> for R {
    fn from(reader: crate::R<T5CONCLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `T5CONCLR` writer"]
pub struct W(crate::W<T5CONCLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<T5CONCLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<T5CONCLR_SPEC>> for W {
    fn from(writer: crate::W<T5CONCLR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "T5CONCLR register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [t5conclr](index.html) module"]
pub struct T5CONCLR_SPEC;
impl crate::RegisterSpec for T5CONCLR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [t5conclr::R](R) reader structure"]
impl crate::Readable for T5CONCLR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [t5conclr::W](W) writer structure"]
impl crate::Writable for T5CONCLR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets T5CONCLR to value 0"]
impl crate::Resettable for T5CONCLR_SPEC {
    #[inline(always)]
