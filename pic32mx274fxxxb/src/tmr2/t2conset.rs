#[doc = "Register `T2CONSET` reader"]
pub struct R(crate::R<T2CONSET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<T2CONSET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<T2CONSET_SPEC>> for R {
    fn from(reader: crate::R<T2CONSET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `T2CONSET` writer"]
pub struct W(crate::W<T2CONSET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<T2CONSET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<T2CONSET_SPEC>> for W {
    fn from(writer: crate::W<T2CONSET_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "T2CONSET register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [t2conset](index.html) module"]
pub struct T2CONSET_SPEC;
impl crate::RegisterSpec for T2CONSET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [t2conset::R](R) reader structure"]
impl crate::Readable for T2CONSET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [t2conset::W](W) writer structure"]
impl crate::Writable for T2CONSET_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets T2CONSET to value 0"]
impl crate::Resettable for T2CONSET_SPEC {
    #[inline(always)]
