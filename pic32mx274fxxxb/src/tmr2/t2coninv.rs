#[doc = "Reader of register T2CONINV"]
pub type R = crate::R<u32, super::T2CONINV>;
#[doc = "Writer for register T2CONINV"]
pub type W = crate::W<u32, super::T2CONINV>;
#[doc = "Register T2CONINV `reset()`'s with value 0"]
impl crate::ResetValue for super::T2CONINV {
    type Type = u32;
    #[inline(always)]
