#[doc = "Reader of register U1ADDRINV"]
pub type R = crate::R<u32, super::U1ADDRINV>;
#[doc = "Writer for register U1ADDRINV"]
pub type W = crate::W<u32, super::U1ADDRINV>;
#[doc = "Register U1ADDRINV `reset()`'s with value 0"]
impl crate::ResetValue for super::U1ADDRINV {
    type Type = u32;
    #[inline(always)]
