#[doc = "Reader of register U1CON"]
pub type R = crate::R<u32, super::U1CON>;
#[doc = "Writer for register U1CON"]
pub type W = crate::W<u32, super::U1CON>;
#[doc = "Register U1CON `reset()`'s with value 0"]
impl crate::ResetValue for super::U1CON {
    type Type = u32;
    #[inline(always)]
