#[doc = "Reader of register DCH3SSA"]
pub type R = crate::R<u32, super::DCH3SSA>;
#[doc = "Writer for register DCH3SSA"]
pub type W = crate::W<u32, super::DCH3SSA>;
#[doc = "Register DCH3SSA `reset()`'s with value 0"]
impl crate::ResetValue for super::DCH3SSA {
    type Type = u32;
    #[inline(always)]
