#[doc = "Reader of register UPLLCONCLR"]
pub type R = crate::R<u32, super::UPLLCONCLR>;
#[doc = "Writer for register UPLLCONCLR"]
pub type W = crate::W<u32, super::UPLLCONCLR>;
#[doc = "Register UPLLCONCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPLLCONCLR {
    type Type = u32;
    #[inline(always)]
