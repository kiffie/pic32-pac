#[doc = "Reader of register SPLLCONSET"]
pub type R = crate::R<u32, super::SPLLCONSET>;
#[doc = "Writer for register SPLLCONSET"]
pub type W = crate::W<u32, super::SPLLCONSET>;
#[doc = "Register SPLLCONSET `reset()`'s with value 0"]
impl crate::ResetValue for super::SPLLCONSET {
    type Type = u32;
    #[inline(always)]
