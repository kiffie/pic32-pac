#[doc = "Reader of register REFO1TRIM"]
pub type R = crate::R<u32, super::REFO1TRIM>;
#[doc = "Writer for register REFO1TRIM"]
pub type W = crate::W<u32, super::REFO1TRIM>;
#[doc = "Register REFO1TRIM `reset()`'s with value 0"]
impl crate::ResetValue for super::REFO1TRIM {
    type Type = u32;
    #[inline(always)]
