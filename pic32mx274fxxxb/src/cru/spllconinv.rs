#[doc = "Reader of register SPLLCONINV"]
pub type R = crate::R<u32, super::SPLLCONINV>;
#[doc = "Writer for register SPLLCONINV"]
pub type W = crate::W<u32, super::SPLLCONINV>;
#[doc = "Register SPLLCONINV `reset()`'s with value 0"]
impl crate::ResetValue for super::SPLLCONINV {
    type Type = u32;
    #[inline(always)]
