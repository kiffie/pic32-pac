#[doc = "Reader of register UPLLCONSET"]
pub type R = crate::R<u32, super::UPLLCONSET>;
#[doc = "Writer for register UPLLCONSET"]
pub type W = crate::W<u32, super::UPLLCONSET>;
#[doc = "Register UPLLCONSET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPLLCONSET {
    type Type = u32;
    #[inline(always)]
