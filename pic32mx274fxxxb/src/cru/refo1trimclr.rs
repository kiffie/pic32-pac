#[doc = "Reader of register REFO1TRIMCLR"]
pub type R = crate::R<u32, super::REFO1TRIMCLR>;
#[doc = "Writer for register REFO1TRIMCLR"]
pub type W = crate::W<u32, super::REFO1TRIMCLR>;
#[doc = "Register REFO1TRIMCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::REFO1TRIMCLR {
    type Type = u32;
    #[inline(always)]
