#[doc = "Reader of register REFO1TRIMINV"]
pub type R = crate::R<u32, super::REFO1TRIMINV>;
#[doc = "Writer for register REFO1TRIMINV"]
pub type W = crate::W<u32, super::REFO1TRIMINV>;
#[doc = "Register REFO1TRIMINV `reset()`'s with value 0"]
impl crate::ResetValue for super::REFO1TRIMINV {
    type Type = u32;
    #[inline(always)]
