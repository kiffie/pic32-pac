#[doc = "Reader of register PB1DIVCLR"]
pub type R = crate::R<u32, super::PB1DIVCLR>;
#[doc = "Writer for register PB1DIVCLR"]
pub type W = crate::W<u32, super::PB1DIVCLR>;
#[doc = "Register PB1DIVCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::PB1DIVCLR {
    type Type = u32;
    #[inline(always)]
