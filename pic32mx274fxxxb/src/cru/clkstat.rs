...
#[doc = "Register `CLKSTAT` writer"]
pub struct W(crate::W<CLKSTAT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLKSTAT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CLKSTAT_SPEC>> for W {
    fn from(writer: crate::W<CLKSTAT_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`write(|w| ..)` method takes [clkstat::W](W) writer structure"]
impl crate::Writable for CLKSTAT_SPEC {
    type Writer = W;
}
