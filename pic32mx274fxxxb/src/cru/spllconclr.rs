#[doc = "Reader of register SPLLCONCLR"]
pub type R = crate::R<u32, super::SPLLCONCLR>;
#[doc = "Writer for register SPLLCONCLR"]
pub type W = crate::W<u32, super::SPLLCONCLR>;
#[doc = "Register SPLLCONCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::SPLLCONCLR {
    type Type = u32;
    #[inline(always)]
