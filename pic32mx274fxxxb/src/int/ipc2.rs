#[doc = "Reader of register IPC2"]
pub type R = crate::R<u32, super::IPC2>;
#[doc = "Writer for register IPC2"]
pub type W = crate::W<u32, super::IPC2>;
#[doc = "Register IPC2 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPC2 {
    type Type = u32;
    #[inline(always)]
