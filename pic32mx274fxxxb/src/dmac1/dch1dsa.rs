#[doc = "Reader of register DCH1DSA"]
pub type R = crate::R<u32, super::DCH1DSA>;
#[doc = "Writer for register DCH1DSA"]
pub type W = crate::W<u32, super::DCH1DSA>;
#[doc = "Register DCH1DSA `reset()`'s with value 0"]
impl crate::ResetValue for super::DCH1DSA {
    type Type = u32;
    #[inline(always)]
