#[doc = "Reader of register DCH1SSA"]
pub type R = crate::R<u32, super::DCH1SSA>;
#[doc = "Writer for register DCH1SSA"]
pub type W = crate::W<u32, super::DCH1SSA>;
#[doc = "Register DCH1SSA `reset()`'s with value 0"]
impl crate::ResetValue for super::DCH1SSA {
    type Type = u32;
    #[inline(always)]
