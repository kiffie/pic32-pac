#[doc = "Reader of register PMD2CLR"]
pub type R = crate::R<u32, super::PMD2CLR>;
#[doc = "Writer for register PMD2CLR"]
pub type W = crate::W<u32, super::PMD2CLR>;
#[doc = "Register PMD2CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::PMD2CLR {
    type Type = u32;
    #[inline(always)]
