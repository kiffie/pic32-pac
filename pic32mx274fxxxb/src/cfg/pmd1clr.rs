#[doc = "Reader of register PMD1CLR"]
pub type R = crate::R<u32, super::PMD1CLR>;
#[doc = "Writer for register PMD1CLR"]
pub type W = crate::W<u32, super::PMD1CLR>;
#[doc = "Register PMD1CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::PMD1CLR {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `HLVDMD`"]
pub type HLVDMD_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `HLVDMD`"]
