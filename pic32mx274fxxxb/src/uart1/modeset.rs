#[doc = "Reader of register MODESET"]
pub type R = crate::R<u32, super::MODESET>;
#[doc = "Writer for register MODESET"]
pub type W = crate::W<u32, super::MODESET>;
#[doc = "Register MODESET `reset()`'s with value 0"]
impl crate::ResetValue for super::MODESET {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `OVFDIS`"]
pub type OVFDIS_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `OVFDIS`"]
