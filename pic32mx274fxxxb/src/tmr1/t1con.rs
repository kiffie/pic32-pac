#[doc = "Reader of register T1CON"]
pub type R = crate::R<u32, super::T1CON>;
#[doc = "Writer for register T1CON"]
pub type W = crate::W<u32, super::T1CON>;
#[doc = "Register T1CON `reset()`'s with value 0"]
impl crate::ResetValue for super::T1CON {
    type Type = u32;
    #[inline(always)]
