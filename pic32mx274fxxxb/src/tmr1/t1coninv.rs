#[doc = "Reader of register T1CONINV"]
pub type R = crate::R<u32, super::T1CONINV>;
#[doc = "Writer for register T1CONINV"]
pub type W = crate::W<u32, super::T1CONINV>;
#[doc = "Register T1CONINV `reset()`'s with value 0"]
impl crate::ResetValue for super::T1CONINV {
    type Type = u32;
    #[inline(always)]
