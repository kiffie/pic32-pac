#[doc = "Reader of register DMASTATINV"]
pub type R = crate::R<u32, super::DMASTATINV>;
#[doc = "Writer for register DMASTATINV"]
pub type W = crate::W<u32, super::DMASTATINV>;
#[doc = "Register DMASTATINV `reset()`'s with value 0"]
impl crate::ResetValue for super::DMASTATINV {
    type Type = u32;
    #[inline(always)]
