#[doc = "Reader of register BMXDUDBA"]
pub type R = crate::R<u32, super::BMXDUDBA>;
#[doc = "Writer for register BMXDUDBA"]
pub type W = crate::W<u32, super::BMXDUDBA>;
#[doc = "Register BMXDUDBA `reset()`'s with value 0"]
impl crate::ResetValue for super::BMXDUDBA {
    type Type = u32;
    #[inline(always)]
