#[doc = "Reader of register BMXDUPBA"]
pub type R = crate::R<u32, super::BMXDUPBA>;
#[doc = "Writer for register BMXDUPBA"]
pub type W = crate::W<u32, super::BMXDUPBA>;
#[doc = "Register BMXDUPBA `reset()`'s with value 0"]
impl crate::ResetValue for super::BMXDUPBA {
    type Type = u32;
    #[inline(always)]
