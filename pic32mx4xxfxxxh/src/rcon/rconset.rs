...
impl W {
    ...
    #[doc = "Bit 8"]
    #[inline]
    pub fn vregs(&mut self) -> _VREGSW {
        _VREGSW { w: self }
    }
    #[doc = "Bit 9"]
    #[inline]
    pub fn cmr(&mut self) -> _CMRW {
        _CMRW { w: self }
    }
    #[doc = "Bit 29"]
    #[inline]
    pub fn hvdr(&mut self) -> _HVDRW {
        _HVDRW { w: self }
    }
}
